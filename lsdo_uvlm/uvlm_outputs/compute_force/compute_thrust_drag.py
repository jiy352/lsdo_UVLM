...
class ThrustDrag(Model):
    ...
    def define(self):
        ...
        if eval_pts_option == 'auto':
            ...
            dcirculation_repeat_dt[0,:,:] = circulation_repeat[0,:,:]*0
            ...
            wing_inital = self.declare_variable(initial_mesh_names[0],shape=(nx,ny,3))
            c_bar = wing_inital[nx-1,0,0] - wing_inital[0,0,0]
