...
class ComputeNormal(Model):
    ...
    def define(self):
        ...
        for i in range(len(vortex_coords_names)):
            ...
            i = vortex_coords[:, :(vortex_coords.shape[1]-1), 1:, :] - vortex_coords[:, 1:, :(vortex_coords.shape[2]-1), :]
            j = vortex_coords[:, :(vortex_coords.shape[1]-1), :(vortex_coords.shape[2]-1), :] - vortex_coords[:, 1:, 1:, :]
